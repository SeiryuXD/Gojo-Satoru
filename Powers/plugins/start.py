...
You can donate by contacting my owner: [Captain Rigz](http://t.me/Seiryuu19)
     """
...
async def start(c: Gojo, m: Message):
    ...
    if m.chat.type == ChatType.PRIVATE:
        ...
        try:
            cpt = f"""
Hey [{m.from_user.first_name}](http://t.me/{m.from_user.username})! I am Gojo Satoru ✨.
I'm here to help you manage your group(s)!
Hit /help to find out more about how to use me in my full potential!

Join my [News Channel](https://t.me/Seiryu19) to get information on all the latest updates."""
...
Join my [News Channel](http://t.me/Seiryu19) to get information on all the latest updates."""
...
async def commands_menu(_, q: CallbackQuery):
    ...
    try:
        cpt = f"""
Hey **[{q.from_user.first_name}](http://t.me/{q.from_user.username})**! I am Gojo Satoru ✨.
I'm here to help you manage your group(s)!
Commands available:
× /start: Start the bot
